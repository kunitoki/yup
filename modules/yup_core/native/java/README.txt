...
dex byte-code in various places in the YUP framework. These are the steps
required to re-generate the dex byte-code from any Java source code inside the
native/java subfolders:

1. Create a new YUP android project with the minimal sdk version which is
...
resemble their package, i.e. a Java class org.kunitoki.yup.HelloWorld.java should
be in the module's native/javacore/app/org/kunitoki/yup folder.  If you wish to
