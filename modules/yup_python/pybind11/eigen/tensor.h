    ...
    Eigen::TensorFixedSize<Scalar_, Eigen::Sizes<Indices...>, Options_, IndexType>>
{
    ...
    static constexpr auto dimensions_descriptor = ::pybind11::detail::concat (const_name<Indices>()...);
...
{
    static constexpr auto details = const_name<NeedsWriteable> (", \"flags.writeable\"", "") + const_name
                                      < static_cast<int> (Type::Layout)
                                 == static_cast<int> (Eigen::RowMajor)
                                        > (", \"flags.c_contiguous\"", ", \"flags.f_contiguous\"");
    static constexpr auto value = const_name ("typing.Annotated[")
...
public:
    ...
    // arrays
    static constexpr auto name = return_descr (get_tensor_descriptor<Type, true, needs_writeable>::value);
