...
struct descr
{
    ...
    template <size_t... Is>
    constexpr descr (const char (&s)[N + 1], index_sequence<Is...>)
        : text { s[Is]..., '\0' }
    {
    }
...
constexpr enable_if_t<B, descr<N1 - 1>> const_name (const char (&text1)[N1], const char (&)[N2])
{
    return const_name (text1);
}

template <bool B, size_t N1, size_t N2>
constexpr enable_if_t<! B, descr<N2 - 1>> const_name (const char (&)[N1], const char (&text2)[N2])
{
...
constexpr descr<N1 + N2 + 1> io_name (const char (&text1)[N1], const char (&text2)[N2])
{
...
constexpr enable_if_t<B, descr<N1 + N2 + 1>>
    io_name (const char (&text1)[N1], const char (&text2)[N2], const char (&)[N3], const char (&)[N4])
{
...
constexpr enable_if_t<! B, descr<N3 + N4 + 1>>
    io_name (const char (&)[N1], const char (&)[N2], const char (&text3)[N3], const char (&text4)[N4])
{
...
template <bool B, size_t N1, size_t N2>
constexpr enable_if_t<B, descr<N1 - 1>> _ (const char (&text1)[N1], const char (&text2)[N2])
{
    return const_name<B, N1, N2> (text1, text2);
}

template <bool B, size_t N1, size_t N2>
constexpr enable_if_t<! B, descr<N2 - 1>> _ (const char (&text1)[N1], const char (&text2)[N2])
{
    return const_name<B, N1, N2> (text1, text2);
}
