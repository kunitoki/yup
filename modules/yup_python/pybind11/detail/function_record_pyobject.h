...
{
    PyObject_HEAD function_record* cpp_func_rec;
};
...
static PyMethodDef tp_methods_impl[] = { { "__reduce_ex__",
...
static PyType_Spec function_record_PyType_Spec = { function_record_PyTypeObject_methods::tp_qualname_impl,
