...
public:
    ...
    bool equal (const object_api& other) const { return rich_compare (other, Py_EQ); }

    bool not_equal (const object_api& other) const { return rich_compare (other, Py_NE); }

    bool operator< (const object_api& other) const { return rich_compare (other, Py_LT); }

    bool operator<= (const object_api& other) const { return rich_compare (other, Py_LE); }

    bool operator> (const object_api& other) const { return rich_compare (other, Py_GT); }

    bool operator>= (const object_api& other) const { return rich_compare (other, Py_GE); }
...
private:
    bool rich_compare (const object_api& other, int value) const;
};
...
public:                                                                                           \
    ...
    Name (handle h, borrowed_t)                                                                   \
        : Parent (h, borrowed_t {})                                                               \
    {                                                                                             \
    }                                                                                             \
    Name (handle h, stolen_t)                                                                     \
        : Parent (h, stolen_t {})                                                                 \
    {                                                                                             \
    }                                                                                             \
...
public:
    ...
    // NOLINTNEXTLINE(google-explicit-constructor)
    bool_ (bool value)
        : object (value ? Py_True : Py_False, borrowed_t {})
    {
    }
...
public:
    ...
    int_()
        : object (PyLong_FromLong (0), stolen_t {})
    {
    }
...
public:
    ...
    set()
        : anyset (PySet_New (nullptr), stolen_t {})
    {
        if (! m_ptr)
        {
...
template <typename D>
bool object_api<D>::rich_compare (const object_api& other, int value) const
{
