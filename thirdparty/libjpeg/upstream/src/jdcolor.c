...
#define ycc_rgb_convert_internal  ycc_rgb_convert_internal_jdcolor
#define gray_rgb_convert_internal  gray_rgb_convert_internal_jdcolor
#define rgb_rgb_convert_internal  rgb_rgb_convert_internal_jdcolor
#include "jdcolext.c"
#undef RGB_RED
#undef RGB_GREEN
#undef RGB_BLUE
