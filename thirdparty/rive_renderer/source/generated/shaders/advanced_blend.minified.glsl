...
#ifdef ENABLE_HSL_BLEND_MODES
case y9:if(ENABLE_HSL_BLEND_MODES){F.xyz=clamp(F.xyz,H0(.0),H0(1.));l0=g7(F.xyz,p.xyz,p.xyz);break;}case z9:if(ENABLE_HSL_BLEND_MODES){F.xyz=clamp(F.xyz,H0(.0),H0(1.));l0=g7(p.xyz,F.xyz,p.xyz);break;}case A9:if(ENABLE_HSL_BLEND_MODES){F.xyz=clamp(F.xyz,H0(.0),H0(1.));l0=K5(F.xyz,p.xyz);break;}case B9:if(ENABLE_HSL_BLEND_MODES){F.xyz=clamp(F.xyz,H0(.0),H0(1.));l0=K5(p.xyz,F.xyz);break;}
#endif
