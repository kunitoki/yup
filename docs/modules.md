...
zero-allocation in the audio callback. Transcendentals link the `sleef_library`
module for vectorized 4-lane math (`u35` under fastMath, `u10` otherwise);
`asmjit_library` provides the compiler and register allocator.
