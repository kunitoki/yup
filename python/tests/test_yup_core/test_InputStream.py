...
class CustomFullInputStream(yup.InputStream):
    data: bytes = bytes()
    offset: int = 0

    def __init__(self, data):
        yup.InputStream.__init__(self)
        self.data = data
        self.offset = 0
    ...
    def readCompressedInt(self):
        ...
        num = yup.ByteOrder.littleEndianInt(b)
...
class CustomMinimalInputStream(yup.InputStream):
    data: bytes = bytes()
    offset: int = 0
