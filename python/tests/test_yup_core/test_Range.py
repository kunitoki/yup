...
def test_range_equality():
    a = yup.Range[int](-10, 10)
    b = yup.Range[int](-10, 10)
    c = yup.Range[int](-11, 10)
...
def test_range_contains():
    ...
    b = yup.Range[int](-15, -5)
    c = yup.Range[int](-15, -10)
...
def test_range_intersects():
    ...
    assert a.getIntersectionWith(b) == yup.Range[int](-10, -5)
    assert b.getIntersectionWith(a) == yup.Range[int](-10, -5)
...
def test_range_intersects():
    ...
    assert a.getUnionWith(100) == yup.Range[int](-10, 100)
    assert b.getUnionWith(-10) == yup.Range[int](-15, -5)
    assert b.getUnionWith(100) == yup.Range[int](-15, 100)

    assert a.getUnionWith(b) == yup.Range[int](-15, 10)
    assert b.getUnionWith(a) == yup.Range[int](-15, 10)
