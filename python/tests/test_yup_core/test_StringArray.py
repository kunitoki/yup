...
def test_constructor_empty():
    string_array = yup.StringArray()
    assert len(string_array) == 0

#==================================================================================================

def test_constructor_copy():
    original = yup.StringArray(["one", "two", "three"])
    copied = yup.StringArray(original)
    assert len(copied) == 3
    assert copied[0] == "one"
    assert copied[1] == "two"
...
def test_constructor_list():
    string_array = yup.StringArray(["apple", "orange", "banana"])
...
def test_constructor_single():
    string_array = yup.StringArray("one")
...
def test_constructor_args():
    string_array = yup.StringArray("one", "two", "three")
    assert len(string_array) == 3
    assert string_array[0] == "one"
...
def test_comparison_operators():
    array1 = yup.StringArray(["apple", "banana", "orange"])
    array2 = yup.StringArray(["apple", "banana", "orange"])
    array3 = yup.StringArray(["apple", "banana", "kiwi"])
...
def test_is_empty_method():
    empty_array = yup.StringArray()
    non_empty_array = yup.StringArray(["apple", "banana"])
...
def test_index_operator():
    string_array = yup.StringArray(["apple", "banana", "orange"])
    assert string_array[0] == "apple"
...
def test_swap_with_method():
    array1 = yup.StringArray(["one", "two", "three"])
    array2 = yup.StringArray(["apple", "banana"])
...
def test_add_array_method():
    string_array1 = yup.StringArray(["apple", "banana"])
    string_array2 = yup.StringArray(["orange", "grape"])
...
def test_merge_array_method():
    string_array1 = yup.StringArray(["apple", "banana"])
    string_array2 = yup.StringArray(["orange", "banana"])
...
def test_remove_range_method():
    string_array = yup.StringArray(["apple", "banana", "orange", "grape"])
...
def test_remove_duplicates_method():
    string_array = yup.StringArray(["apple", "banana", "orange", "banana", "grape"])
...
def test_sort_method():
    string_array = yup.StringArray(["orange", "banana", "apple", "grape"])
    string_array.sort(False)
    assert len(string_array) == 4
    assert string_array[0] == "apple"
    assert string_array[3] == "orange"

    string_array = yup.StringArray(["Apple", "orange", "banana", "apple"])
    string_array.sort(True)
    assert len(string_array) == 4
    assert string_array[0] == "Apple"
    assert string_array[3] == "orange"

    string_array = yup.StringArray(["orange", "banana", "apple", "Apple"])
    string_array.sort(False)
    assert len(string_array) == 4
    assert string_array[0] == "Apple"
    assert string_array[3] == "orange"
...
def test_sort_natural_method():
    string_array = yup.StringArray(["apple 10", "apple 2", "banana 1", "banana 10"])
...
def test_from_tokens_method():
    ...
    result = yup.StringArray.fromTokens(string_to_tokenise, preserveQuotedStrings=False)
    assert len(result) == 3
...
def test_from_tokens_methodwith_break_character():
    string_to_tokenise = "apple, banana, orange"
    result = yup.StringArray.fromTokens(string_to_tokenise, ",", "")
    assert len(result) == 3
    assert result[0] == "apple"
...
def test_from_tokens_method_with_quotes():
    ...
    result = yup.StringArray.fromTokens(string_to_tokenise, preserveQuotedStrings=True)
    assert len(result) == 3
    assert result[0] == "apple"
...
def test_from_lines_method():
    result = yup.StringArray.fromLines("")
    assert len(result) == 0
    ...
    result = yup.StringArray.fromLines("apple\nbanana\norange")
    assert len(result) == 3
    assert result[0] == "apple"
    assert result[1] == "banana"
    assert result[2] == "orange"
