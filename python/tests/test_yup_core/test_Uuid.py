...
def test_constuct_string():
    a = yup.Uuid("974cc888-0d9a-4d47-8930-913f682430cb")
    assert a.getRawData() == b"\227L\310\210\r\232MG\2110\221?h$0\313"

#==================================================================================================

def test_constuct_bytes():
    a = yup.Uuid(b"\227L\310\210\r\232MG\2110\221?h$0\313")
    ...
    b = yup.Uuid(b'\x00\x01\x02\x03\x04\x05\x06\x07\x08\t\n\x0b\x0c\r\x0e\x0f')
...
def test_constuct_comparisons():
    a = yup.Uuid(b'\x00\x01\x02\x03\x04\x05\x06\x07\x08\t\n\x0b\x0c\r\x0e\x0f')
    b = yup.Uuid(b'\x00\x01\x02\x03\x04\x05\x06\x07\x08\t\n\x0b\x0c\r\x0e\x1f')
    assert a == a
    assert a != b
    assert a < b
...
def test_repr():
    a = yup.Uuid('{00010203-0405-0607-0809-0a0b0c0d0e0f}')
    assert repr(a) == "yup.Uuid('{00010203-0405-0607-0809-0a0b0c0d0e0f}')"
