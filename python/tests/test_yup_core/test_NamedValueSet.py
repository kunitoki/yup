...
NV = yup.NamedValueSet.NamedValue

#==================================================================================================

def test_constructor_empty():
    named_value_set = yup.NamedValueSet()
...
def test_constructor_list_of_namedvalues():
    named_value_set = yup.NamedValueSet([
        NV(yup.Identifier("name1"), 42),
        NV(yup.Identifier("name2"), "value"),
        NV(yup.Identifier("name3"), True)
    ])
...
def test_copy_constructor():
    original_set = yup.NamedValueSet({
        "name1": 42,
        "name2": "value",
        "name3": True
    })

    copied_set = yup.NamedValueSet(original_set)
...
def test_equality_operators():
    set1 = yup.NamedValueSet({
        "name1": 42,
        "name2": "value",
        "name3": True
    })

    set2 = yup.NamedValueSet({
        "name1": 42,
        "name2": "value",
        "name3": True
    })

    set3 = yup.NamedValueSet({
        "name1": 42,
        "name2": "value",
        "name3": False,
        "name4": 1.2
...
def test_operator_bracket():
    ...
    assert named_value_set[yup.Identifier("name2")] == "value"
    assert named_value_set[yup.Identifier("name3")] == True
...
def test_get_with_default():
    ...
    assert named_value_set.getWithDefault(yup.Identifier("name1"), 100) == 42
    assert named_value_set.getWithDefault(yup.Identifier("name4"), "default") == "default"
...
def test_set():
    ...
    assert named_value_set.set(yup.Identifier("name1"), 42) is True
    assert named_value_set.size() == 1

    # Modifying an existing named value
    assert named_value_set.set(yup.Identifier("name1"), 100) is True
    assert named_value_set.size() == 1
...
def test_contains():
    ...
    assert named_value_set.contains(yup.Identifier("name1")) is True
    assert named_value_set.contains(yup.Identifier("name4")) is False
...
def test_remove():
    ...
    assert named_value_set.contains(yup.Identifier("name2")) is False

    # Removing a non-existing named value
    assert named_value_set.remove(yup.Identifier("name4")) is False
    assert named_value_set.size() == 2
...
def test_get_name():
    ...
    assert named_value_set.getName(0) == yup.Identifier("name1")
    assert named_value_set.getName(1) == yup.Identifier("name2")
...
def test_index_of():
    ...
    assert named_value_set.indexOf(yup.Identifier("name1")) == 0
...
def test_get_var_pointer():
    ...
    var_pointer_non_existing = named_value_set.getVarPointer(yup.Identifier("name4"))
...
def test_copy_to_xml_attributes():
    ...
    xml_element = yup.XmlElement("test_element")
...
def test_set_from_xml_attributes():
    ...
    assert named_value_set.size() == 3
    assert named_value_set[yup.Identifier("name1")] == "42"
    assert named_value_set[yup.Identifier("name2")] == "value"
    assert named_value_set[yup.Identifier("name3")] == "1"
