...
class CustomComparatorBool(yup.Array[bool].Comparator):
...
class CustomComparatorInt(yup.Array[int].Comparator):
    def compareElements(self, x, y):
        if x == y: return 0
        elif x < y: return -1
        else: return 1
...
class CustomComparatorFloat(yup.Array[float].Comparator):
    def compareElements(self, x, y):
        if x == y: return 0
        elif x < y: return -1
        else: return 1
