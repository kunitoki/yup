...
public:
    ...
    virtual float dpiScale(void*) const = 0;
    ...
    virtual void onSizeChanged(void*, int width, int height, uint32_t sampleCount) {}
    ...
    virtual void end(void*, std::vector<uint8_t>* pixelData = nullptr) = 0;
    virtual void tick(){};
